...
<form action="?page=save_edit_comic" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            ...
            <td width="30px">:</td>
            <td><input type="text" name="title" class="form-control" value="<?php echo $row['comic_title']?>" /></td>
        </tr>
        <tr>
            <td>Description</td>
            <td>:</td>
        ...
        <tr>
            <td>Cover</td>
            <td>:</td>
            <td><img src="<?php echo $row['comic_cover']?>" alt=""></td><br>
            <td><input type="file" name="cover" class="form-control" value="<?php echo $row['comic_cover']?>" /></td>
        </tr>
        <tr>
            <td>Released Date</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td><input type="text" name="id" value="<?php echo $_GET['id'] ?>" hidden>
                <input type="submit" value="Simpan" name="btn btn-primary" />
            </td>
        </tr>
    </table>
</form>